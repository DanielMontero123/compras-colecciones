...
class FragmentColeccionesDos : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_colecciones_dos, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btn.setOnClickListener {
            ...
            val et2: EditText = requireView().findViewById(R.id.txtFiguraFragmento)
            ...
            activityContenedora!!.enviarFigura(et2.text.toString())
