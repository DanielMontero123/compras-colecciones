...
class BusquedasActivity : AppCompatActivity() {
    ...
    private val BASE_URL = "https://www.sideshow.com/manufacturers/hot-toys/"
    private val SEARCH_PATH = "https://www.sideshow.com/search?keywords="
            ...
            override fun onQueryTextSubmit(cadena: String?): Boolean {
                cadena?.let {
                    if (URLUtil.isValidUrl(it)){
                        ...
                        wvNavegacion.loadUrl("$SEARCH_PATH$it")
                    }
                }
                return false
            }
